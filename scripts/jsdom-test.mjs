...
// 注：本文件是原 scripts/test-frontend.mjs 的 JS 主体（迁移为 uv 工具链后，
// Python 的 frontend 命令调用本文件并断言退出码；前端测试必须跑在 node+jsdom 环境）。
//
...
//   npx -y -p jsdom@24 node scripts/jsdom-test.mjs
