...
//!
//! ```rust
//! use mdns::{ServiceDaemon, ServiceEvent};
//!
//! // Create a daemon
...
pub use dns_parser::{InterfaceId, MAX_PKT_DEFAULT, RRType, ScopedIp, ScopedIpV4, ScopedIpV6};
pub use error::{Error, Result};
pub use service_daemon::{
    DaemonEvent, DaemonStatus, DnsNameChange, HostnameResolutionEvent,
    IP_CHECK_INTERVAL_IN_SECS_DEFAULT, IfKind, IfPredicate, MDNS_PORT, Metrics,
    SERVICE_NAME_LEN_MAX_DEFAULT, ServiceDaemon, ServiceEvent, UnregisterStatus,
